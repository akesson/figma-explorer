...
> models::InlineObject27 get_local_variables(file_key)
Get local variables
...
> models::InlineObject28 get_published_variables(file_key)
...
> models::InlineObject29 post_variables(file_key, post_variables_request)
