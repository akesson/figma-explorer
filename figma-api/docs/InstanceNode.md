...
**r#type** | **String** | The type of this node, represented by the string literal \"INSTANCE\" | 
...
**dev_status** | Option<[**models::DevStatusTraitDevStatus**](DevStatusTrait_devStatus.md)> |  | [optional]
**component_id** | **String** | ID of component that this instance came from. | 
**is_exposed_instance** | Option<**bool**> | If true, this node has been marked as exposed to its containing component or component set. | [optional][default to false]
**exposed_instances** | Option<**Vec<String>**> | IDs of instances that have been exposed to this node's level. | [optional]
**component_properties** | Option<[**std::collections::HashMap<String, models::ComponentProperty>**](ComponentProperty.md)> | A mapping of name to `ComponentProperty` for all component properties on this instance. Each property has a type, value, and other optional values. | [optional]
**overrides** | [**Vec<models::Overrides>**](Overrides.md) | An array of all of the fields directly overridden on this instance. Inherited overrides are not included. | 
