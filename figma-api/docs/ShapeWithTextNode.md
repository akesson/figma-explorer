...
**r#type** | **String** | The type of this node, represented by the string literal \"SHAPE_WITH_TEXT\" | 
...
**shape_type** | [**models::ShapeType**](ShapeType.md) | Geometric shape type. Most shape types have the same name as their tooltip but there are a few exceptions. ENG_DATABASE: Cylinder, ENG_QUEUE: Horizontal cylinder, ENG_FILE: File, ENG_FOLDER: Folder. | 
