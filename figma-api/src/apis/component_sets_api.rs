...
) -> Result<models::InlineObject17, Error<GetComponentSetError>> {
    let uri_str = format!(
...
) -> Result<models::InlineObject16, Error<GetFileComponentSetsError>> {
    let uri_str = format!(
...
) -> Result<models::InlineObject15, Error<GetTeamComponentSetsError>> {
    let uri_str = format!(
