...
pub struct NodeAction {
    ...
    #[serde(
        rename = "overlayRelativePosition",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "resetInteractiveComponents",
        skip_serializing_if = "Option::is_none"
    )]
...
impl NodeAction {
    ...
    pub fn new(
        ...
        transition: Option<models::Transition>,
    ) -> NodeAction {
        NodeAction {
            r#type,
            destination_id,
            navigation,
            transition: if let Some(x) = transition {
                Some(Box::new(x))
            } else {
                None
            },
