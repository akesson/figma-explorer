...
impl HasLayoutTrait {
    pub fn new(
        absolute_bounding_box: Option<models::Rectangle>,
        absolute_render_bounds: Option<models::Rectangle>,
    ) -> HasLayoutTrait {
        HasLayoutTrait {
            absolute_bounding_box: if let Some(x) = absolute_bounding_box {
                Some(Box::new(x))
            } else {
                None
            },
            absolute_render_bounds: if let Some(x) = absolute_render_bounds {
                Some(Box::new(x))
            } else {
                None
            },
