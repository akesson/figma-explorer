...
pub struct LocalVariable {
    ...
    pub resolved_type: models::VariableResolvedDataType,
...
impl LocalVariable {
    ...
    pub fn new(
        ...
        resolved_type: models::VariableResolvedDataType,
        values_by_mode: std::collections::HashMap<String, models::LocalVariableValuesByModeValue>,
        remote: bool,
        description: String,
        hidden_from_publishing: bool,
        scopes: Vec<models::VariableScope>,
        code_syntax: models::VariableCodeSyntax,
    ) -> LocalVariable {
        LocalVariable {
            id,
            name,
