...
pub struct InstanceNode {
    ...
    #[serde(
        rename = "componentPropertyReferences",
    ...
    #[serde(
        rename = "gridChildHorizontalAlign",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "strokesIncludedInLayout",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "counterAxisAlignContent",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub fill_override_table:
        Option<std::collections::HashMap<String, models::HasGeometryTraitAllOfFillOverrideTable>>,
    ...
    #[serde(
        rename = "individualStrokeWeights",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(rename = "isExposedInstance", skip_serializing_if = "Option::is_none")]
    pub is_exposed_instance: Option<bool>,
    /// IDs of instances that have been exposed to this node's level.
    #[serde(rename = "exposedInstances", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "componentProperties",
        skip_serializing_if = "Option::is_none"
    )]
    pub component_properties: Option<std::collections::HashMap<String, models::ComponentProperty>>,
    /// An array of all of the fields directly overridden on this instance. Inherited overrides are not included.
    #[serde(rename = "overrides")]
    pub overrides: Vec<models::Overrides>,
}
...
impl InstanceNode {
    pub fn new(
        ...
        blend_mode: models::BlendMode,
        children: Vec<models::SubcanvasNode>,
        absolute_bounding_box: models::Rectangle,
        absolute_render_bounds: models::Rectangle,
        clips_content: bool,
        fills: Vec<models::Paint>,
        effects: Vec<models::Effect>,
        component_id: String,
        overrides: Vec<models::Overrides>,
    ) -> InstanceNode {
        InstanceNode {
            id,
            name,
