...
pub struct LocalVariableCollection {
    ...
    #[serde(
        rename = "parentVariableCollectionId",
    ...
    #[serde(
        rename = "rootVariableCollectionId",
        skip_serializing_if = "Option::is_none"
    )]
    pub root_variable_collection_id: Option<String>,
    ...
    pub variable_overrides: Option<
        std::collections::HashMap<String, std::collections::HashMap<String, models::VariableValue>>,
    >,
...
impl LocalVariableCollection {
    ...
    pub fn new(
        ...
        name: String,
        key: String,
        modes: Vec<models::LocalVariableCollectionModesInner>,
        ...
        LocalVariableCollection {
            ...
            root_variable_collection_id: None,
