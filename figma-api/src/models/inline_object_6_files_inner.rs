...
pub struct InlineObject6FilesInner {
    /// The file's key.
    #[serde(rename = "key")]
    pub key: String,
    /// The file's name.
...
impl InlineObject6FilesInner {
    pub fn new(key: String, name: String, last_modified: String) -> InlineObject6FilesInner {
        InlineObject6FilesInner {
            key,
            name,
            thumbnail_url: None,
            last_modified,
